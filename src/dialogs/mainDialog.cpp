...
#include "bridge.rs.h"  // Rust bridge via cxx (generated by cxx-build)
...
void MainDialog::updateTitle(bool saved) {
    ...
    // Get playbook name from Rust controller via cxx bridge
    std::string playbookName = std::string(pbc2rust::pbc_get_playbook_name());
